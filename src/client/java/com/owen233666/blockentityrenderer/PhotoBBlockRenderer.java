...
//        switch (direction) {
//            case NORTH -> {
//                renderPhotos(poseStack, multiBufferSource, textureLocation, i, null, 0.99f, 0.0f, 0.7f, 0.346875f, 0.28125f,0.684375f);
//            }
//            case SOUTH -> {
//                renderPhotos(poseStack, multiBufferSource, textureLocation, i, -1.0f, -0.01f, 180.0f, 0.346875f, 0.7f, 0.28125f,0.684375f);
//            }
//            case WEST -> {
////                renderPhotos(poseStack, multiBufferSource, textureLocation, i, -1.0f, 0.99f, 90.0f);
//            }
...
//
//    private void renderPhotos(PoseStack poseStack, MultiBufferSource multiBufferSource, ResourceLocation textureLocation,
//                              int packedLight, @Nullable Float offsetX, @Nullable Float offsetZ, Float yRotationDegrees, float centerX1, float centerY1, float centerX2, float centerY2) {
//
//        poseStack.pushPose();
