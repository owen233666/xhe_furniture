...
public class PaintFrameBlockEntityRenderer implements BlockEntityRenderer<PaintFrameBlockEntity> {
    ...
    public PaintFrameBlockEntityRenderer(BlockEntityRendererProvider.Context context, boolean bool) {
    ...
    public void render(PaintFrameBlockEntity paintFrameBlockEntity, float f, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j) {
        ...
        ItemStack stack = paintFrameBlockEntity.getInv().get(0);
        ...
        itemRenderer.renderStatic(stack, ItemDisplayContext.FIXED, i, j, poseStack, multiBufferSource, paintFrameBlockEntity.getLevel(), 0);
        poseStack.popPose();
    }
