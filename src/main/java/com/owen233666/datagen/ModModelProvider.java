 ...
 */
// Superseded: this provider is referenced by XheFurnitureDataGenerator only in commented-out
// form, so `runDatagen` does not run it. The blockstate/item models it used to build are
// hand-written under src/main/resources/assets/xhe_furniture. Re-enable it deliberately if
// model datagen is ever wanted back.
//#if FABRIC
...
//$$ //        }
//$$ //        MultipartBlockStateSupplier multipartBlockStateSupplierForPaintBrush = MultipartBlockStateSupplier.create(ModBlocks.PAINT_BRUSH.get());
//$$ //        for (Direction direction : Direction.Type.HORIZONTAL){
//$$ //            for (int i = 0; i <= 64; i++) {
//$$ //
//$$ //
...
//$$ //
//$$ //        MultipartBlockStateSupplier multipartBlockStateSupplierForPaintCan = MultipartBlockStateSupplier.create(ModBlocks.PAINT_CAN.get());
//$$ //        MultipartBlockStateSupplier multipartBlockStateSupplierForMessyPaintCan = MultipartBlockStateSupplier.create(ModBlocks.MESSY_PAINT_CAN.get());
//$$ //        for (Direction direction : Direction.Type.HORIZONTAL){
//$$ //            VariantSettings.Rotation rotation = switch (direction) {
//$$ //                case NORTH -> VariantSettings.Rotation.R0;
//$$ //                case EAST -> VariantSettings.Rotation.R90;
...
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_OAK.get(), "oak");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_SPRUCE.get(), "spruce");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_JUNGLE.get(), "jungle");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_BIRCH.get(), "birch");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_ACACIA.get(), "acacia");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_DARK_OAK.get(), "dark_oak");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_MANGROVE.get(), "mangrove");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_CHERRY.get(), "cherry");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_BAMBOO.get(), "bamboo");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_PALE_OAK.get(), "pale_oak");
//$$ //            blockIdentifierMap.put(ModBlocks.PAINTING_FRAME_BLACKSTONE.get(), "blackstone");
//$$ //
//$$ //            for (Direction direction : Direction.Type.HORIZONTAL){
//$$ //                VariantSettings.Rotation rotation = switch (direction) {
//$$ //                    case NORTH -> VariantSettings.Rotation.R0;
